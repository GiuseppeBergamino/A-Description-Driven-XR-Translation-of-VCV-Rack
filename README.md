...
The prototype uses a custom VCV Rack Bridge module to export a semantic JSON description of the current patch and to exchange runtime parameter-control messages with the Quest client through OSC/UDP.
...
## Current scope
The current prototype supports parameter-level MR reconstruction and bidirectional synchronization between VCV Rack and Meta Quest 3. It does not yet support cable editing, routing operations, user-defined spatial layouts, complete reconstruction of fully custom Rack controls, or module-specific MR-native representations.
